            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  <th className="text-left py-4 px-4 text-gray-400 font-medium">프로젝트</th>
                  <th className="text-left py-4 px-4 text-gray-400 font-medium">소개/사용기술</th>
                  <th className="text-left py-4 px-4 text-gray-400 font-medium">상세보기</th>
                </tr>
              </thead>
              <tbody>
