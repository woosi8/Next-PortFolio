    ...
    <section className="pt-24 pb-16 px-6">
      ...
      >
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-400 text-lg mb-8">
              Web을 다루는 6년차 프론트 앤드 개발자 최 혁 입니다.
            </p>
          </div>
        ...
        >
          ...
          >
            <div>
              Web 개발을 다루는 6년차 개발자입니다. 결과 중심적인 사고를
              바탕으로 클라이언트의 요구를 명확하게 구현하는 것을 목표로 삼는
              개발자 입니다. <br />
            </div>
            <div>
              서비스 베타부터 실제 운영 단계까지 프론트엔드 팀과 시스템 전체를
              리드해 왔으며, Next.js와 React, TypeScript를 활용해 대규모 B2B
              SaaS 시스템의 코어 아키텍처를 구축해 왔습니다.
              <br />
            </div>
            <div>
