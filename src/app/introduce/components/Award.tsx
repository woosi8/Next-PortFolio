const Award = () => {
  const awards = [
    ...
    },
    {
      ...
      description: "L IDR 좋바의 크롤링의 오점 + 서울 이용한 챗덱의 프로젝트로 성장, 추천 서비스",
      icon: "🏆"
    },
    {
      year: "2019년",
      title: "원보 스타트업 어업스, 강기노 대학생 좋은 창업서비회 콘텐츠, 출석(팀워크여성 창업경진대회,스마트시티 창선 지 + 다양, 응도솀, 다항, 취약수각 외",
    ...
    },
    {
      ...
      description: "L [UC-LAB] GAN로긴 DNN로을 활용한 ANOMALY DETECTION에 관한 연구 🏆",
      icon: "🏆"
    }
  ];
          ...
          <div className="space-y-8">
            {awards.map((award, index) => (
              <div key={index} className="flex items-start gap-6">
                <div className="text-gray-400 font-medium min-w-0 flex-shrink-0">
                  {award.year}
                </div>
